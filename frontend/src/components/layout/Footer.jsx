        ...
        <div className="footer-top">
          <div className="footer-brand">
            ...
            <div className="social-links">
              {/* GitHub */}
              <a href="https://github.com/elevate-iiitn" target="_blank" rel="noreferrer" className="social-link" aria-label="GitHub">
              ...
              {/* LinkedIn */}
              <a href="https://www.linkedin.com/company/elevate-iiitn/posts/?feedView=all" target="_blank" rel="noreferrer" className="social-link" aria-label="LinkedIn">
