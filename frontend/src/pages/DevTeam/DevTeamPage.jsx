...
const devTeam = [
  { id: 'vinay', name: 'Vinay Kumrawat', role: 'Full Stack Developer', githubUrl: 'https://github.com/VinayCodes17', linkedinUrl: 'https://www.linkedin.com/in/vinay-kumrawat-370913390/', imageUrl: '/dev_pic/Vinay_Kumrawat.png' },
  { id: 'tushar', name: 'Tushar Agarwal', role: 'Full Stack Developer', githubUrl: 'https://github.com/tushar-313', linkedinUrl: 'https://www.linkedin.com/in/tushar-agarwal-205b01374', imageUrl: '/dev_pic/Tushar_Agarwal.png' },
  { id: 'bishal', name: 'Bishal Dey', role: 'Full Stack Developer', githubUrl: 'https://github.com/11deybishal-commits', linkedinUrl: 'https://www.linkedin.com/in/bishal-dey11', imageUrl: '/dev_pic/Bishal_dey_1.jpg' },
  { id: 'aviral', name: 'Aviral Joshi', role: 'Backend and Database Engineer', githubUrl: 'https://github.com/aviraL27', linkedinUrl: 'https://www.linkedin.com/in/aviral-joshi-a98a67373', imageUrl: '/dev_pic/Aviral_Joshi.png' }
];
      ...
      <div className="cyber-card-inner">
        ...
        <div className="cyber-info">
          ...
          <div className="cyber-socials">
            {node.githubUrl && (
              <a href={node.githubUrl} target="_blank" rel="noreferrer" className="cyber-social-link cyber-github">
            ...
            {node.linkedinUrl && (
              <a href={node.linkedinUrl} target="_blank" rel="noreferrer" className="cyber-social-link cyber-linkedin">
                <svg viewBox="0 0 24 24" fill="currentColor" width="14" height="14">
