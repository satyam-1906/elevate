export const knowledgeResources = [
  ...
  // ==========================================
  // AI/ML - Advanced & Exclusive Extensions
  // ==========================================
  {
    id: 122,
    ...
    difficulty: "Beginner",
    description: "The official, step-by-step beginner tutorials for PyTorch, focusing on tensors, datasets, neural network building, and optimization loops.",
    author: "PyTorch Foundation",
    tags: ["PyTorch", "Python", "Deep Learning", "Fundamentals"],
    cost: "Free",
    official: true,
    links: [{ label: "Start Learning", url: "https://pytorch.org/tutorials/beginner/basics/intro.html" }],
    rating: "9.6/10"
  },
  {
    id: 123,
    ...
    difficulty: "Intermediate",
    description: "An incredibly comprehensive, interactive book that covers deeply theoretical concepts mapped seamlessly to runnable PyTorch and TensorFlow code.",
    author: "Aston Zhang et al.",
    tags: ["Deep Learning", "Math", "PyTorch", "TensorFlow"],
    cost: "Free",
    official: false,
    links: [{ label: "Read Book", url: "https://d2l.ai/" }],
    rating: "9.9/10"
  },
  {
    id: 124,
    ...
    type: "Documentation",
    difficulty: "Beginner",
    description: "Google's official guide to starting your journey in Machine Learning utilizing Keras and TensorFlow 2.x.",
    author: "Google",
    tags: ["TensorFlow", "Keras", "Python"],
    cost: "Free",
    official: true,
    links: [{ label: "TF Docs", url: "https://www.tensorflow.org/tutorials" }],
    rating: "9.4/10"
  },
  {
    id: 125,
    ...
    type: "University Course",
    difficulty: "Advanced",
    description: "The gold-standard curriculum for computer vision. Deeply covers CNN architectures, image classification, object detection, and visual transformers.",
    author: "Stanford University",
    tags: ["Computer Vision", "CNN", "Deep Learning", "Stanford"],
    cost: "Free",
    official: true,
    links: [{ label: "Course Materials", url: "http://cs231n.stanford.edu/" }],
    rating: "9.8/10"
  },
  {
    id: 126,
    title: "Hugging Face Open-Source Course",
    domain: "AI/ML",
    type: "Course",
    difficulty: "Intermediate",
    description: "Learn how to use Transformer models efficiently, covering NLP, audio, and computer vision with the Transformers library.",
    author: "Hugging Face",
    tags: ["Transformers", "NLP", "Hugging Face", "LLMs"],
    cost: "Free",
    official: true,
    links: [{ label: "Course", url: "https://huggingface.co/learn/" }],
    rating: "9.7/10"
  },
  {
    id: 127,
    ...
    type: "University Course",
    difficulty: "Advanced",
    description: "One of the most rigorous courses on Natural Language Processing covering Word2Vec, Attention mechanisms, and modern LLMs.",
    author: "Stanford University",
    tags: ["NLP", "Deep Learning", "LLMs", "Stanford"],
    cost: "Free",
    official: true,
    links: [{ label: "Syllabus", url: "https://web.stanford.edu/class/cs224n/" }],
    rating: "9.8/10"
  },
  {
    id: 128,
    ...
    type: "Documentation",
    difficulty: "Beginner",
    description: "The absolute best mathematical and practical documentation on classical machine learning algorithms like Random Forests and SVMs.",
    author: "Scikit-Learn",
    tags: ["Machine Learning", "Classical ML", "Data Science"],
    cost: "Free",
    official: true,
    links: [{ label: "User Guide", url: "https://scikit-learn.org/stable/user_guide.html" }],
    rating: "9.6/10"
  },
  {
    id: 129,
    ...
    difficulty: "Intermediate",
    description: "Curated scripts and notebooks demonstrating advanced deep learning solutions (time series, generative AI) explicitly in Keras 3 (PyTorch/TF/JAX).",
    author: "Keras Team",
    tags: ["Keras", "Generative AI", "Code Examples"],
    cost: "Free",
    official: true,
    links: [{ label: "Examples", url: "https://keras.io/examples/" }],
    rating: "9.5/10"
  },
  {
    id: 130,
    ...
    type: "Course",
    difficulty: "Advanced",
    description: "Bridging the gap between training models in notebooks and serving them in production (MLOps, CI/CD for ML, scaling data).",
    author: "FSDL Team",
    tags: ["MLOps", "Production ML", "Deployment"],
    cost: "Free",
    official: true,
    links: [{ label: "FSDL Course", url: "https://fullstackdeeplearning.com/" }],
    rating: "9.7/10"
  },
  {
    id: 131,
    ...
    type: "University Course",
    difficulty: "Intermediate",
    description: "MIT's foundational course on deep learning containing software labs in TensorFlow covering computer vision, sequence modeling, and reinforcement learning.",
    author: "MIT",
    tags: ["MIT", "Deep Learning", "Reinforcement Learning"],
    cost: "Free",
    official: true,
    links: [{ label: "Course Site", url: "http://introtodeeplearning.com/" }],
    rating: "9.5/10"
  },
  {
    id: 132,
    ...
    difficulty: "Advanced",
    description: "The ultimate resource linking breaking AI research papers to their official GitHub repositories with verified state-of-the-art benchmarks.",
    author: "Meta AI",
    tags: ["Research", "SOTA", "Papers", "Code"],
    cost: "Free",
    official: true,
    links: [{ label: "Browse Trends", url: "https://paperswithcode.com/" }],
    rating: "9.9/10"
  },
  {
    id: 133,
    title: "Gymnasium (OpenAI Gym) Documentation",
    domain: "AI/ML",
    type: "Documentation",
    difficulty: "Intermediate",
    description: "The current standard API for all reinforcement learning algorithms, providing environments like CartPole, Atari, and robotics simulations.",
    author: "Farama Foundation",
    tags: ["Reinforcement Learning", "Gymnasium", "Environment"],
    cost: "Free",
    official: true,
    links: [{ label: "Gymnasium Docs", url: "https://gymnasium.farama.org/" }],
    rating: "9.4/10"
  },
  {
    id: 134,
    title: "DeepMind Research & Publications",
    domain: "AI/ML",
    type: "Articles / Papers",
    difficulty: "Advanced",
    description: "Official blogs and published research breakthroughs covering AGI, AlphaFold, Reinforcement Learning, and Gemini architectures.",
    author: "Google DeepMind",
    tags: ["Research", "AGI", "DeepMind", "Publications"],
    cost: "Free",
    official: true,
    links: [{ label: "Read Research", url: "https://deepmind.google/research/" }],
    rating: "9.6/10"
  },
  {
    id: 135,
    ...
    domain: "AI/ML",
    type: "Book",
    description: "A foundational book strictly covering the continuous integration and delivery lifecycle required to keep machine learning models robust in enterprise cloud contexts.",
    difficulty: "Intermediate",
    author: "Noah Gift & Alfredo Deza",
    tags: ["MLOps", "DevOps", "Enterprise", "Scaling"],
    cost: "Paid (O'Reilly)",
    official: false,
    links: [{ label: "O'Reilly Book", url: "https://www.oreilly.com/library/view/practical-mlops/9781098103002/" }],
    rating: "9.1/10"
  },
  {
    id: 136,
    ...
    domain: "AI/ML",
    type: "Course",
    description: "An extreme deep-dive into how PyTorch actually works. You recreate PyTorch architectures entirely from scratch, including custom backpropagation and optimizers.",
    difficulty: "Advanced",
    author: "Jeremy Howard",
    tags: ["Deep Learning", "Architecture", "Math", "PyTorch"],
    cost: "Free",
    official: false,
    links: [{ label: "Part 2 Course", url: "https://course.fast.ai/Lessons/lesson13.html" }],
    rating: "9.8/10"
  }
];
